...
public class Cliente {
	...
	public void setData_nasc(Date value) {
		data_nasc = value;
	}
	
	public void setData_nasc(java.sql.Date value) {
		Date vlr = null;
		if (value != null) {
			vlr = Date.from(value.toLocalDate().atStartOfDay(ZoneId.systemDefault()).toInstant());
		}
		data_nasc = vlr;
	}
	...
	public void create() throws SQLException {
		...
		if (data_nasc != null)
			dtNasc = new java.sql.Date(data_nasc.getTime());
		stmt.setDate(11, dtNasc);
